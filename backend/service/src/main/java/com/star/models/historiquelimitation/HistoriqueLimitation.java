...
@NoArgsConstructor
@AllArgsConstructor
public class HistoriqueLimitation implements ImportCSV {
    ...
    public static boolean isSiteHTA(String meteringPointMrid) {
        return equalsIgnoreCase(HistoriqueLimitation.CODE_SITE_HTA, substring(meteringPointMrid, 0, 3));
    }

    public static boolean isSiteHTB(String meteringPointMrid) {
        return equalsIgnoreCase(HistoriqueLimitation.CODE_SITE_HTB_CART, substring(meteringPointMrid, 0, 4)) ||
                equalsIgnoreCase(HistoriqueLimitation.CODE_SITE_HTB_PDL, substring(meteringPointMrid, 0, 3));
    }
}
