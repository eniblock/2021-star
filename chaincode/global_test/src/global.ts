...
export class GlobalContract extends Contract {
    public async InitLedger(ctx: Context): Promise<void> {
    console.debug('========= Chaincode Init =========');
  ...
  public async Create(ctx: Context): Promise<void> {
    console.debug(`Transaction ID: ${ctx.stub.getTxID()}`);
    console.debug(util.format('Args: %j', ctx.stub.getArgs()));
