...
export class EnergyAmountController {
    ...
    public static async createTSOEnergyAmount(
        ...
        try {
            ...
            throw new Error(`ERROR createEnergyAmount-> Input string NON-JSON value`);
        }
        ...
        try {
            ...
            throw new Error(`ERROR createEnergyAmount getActivationDocument-> Input string NON-JSON value`);
        }
        ...
        try {
            ...
            throw new Error(`ERROR createEnergyAmount getSite-> Input string NON-JSON value`);
        }

        if (orderObj.registeredResourceMrid !== energyAmountInput.registeredResourceMrid) {
            throw new Error(`ERROR createEnergyAmount mismatch beetween registeredResourceMrid in Activation Document : ${orderObj.registeredResourceMrid} and Energy Amount : ${energyAmountInput.registeredResourceMrid}.`);
        }
        ...
        if (JSON.stringify(dateBegin) !== JSON.stringify(dateEnd)) {
            throw new Error(`ERROR createEnergyAmount mismatch in timeInterval both date must be the same day.(${JSON.stringify(dateBegin)} vs ${JSON.stringify(dateEnd)})`);
        } else if (JSON.stringify(dateBegin) !== JSON.stringify(orderDateStart)) {
            throw new Error(`ERROR createEnergyAmount mismatch between ENE : ${JSON.stringify(dateBegin)} and Activation Document : ${JSON.stringify(orderDateStart)} dates.`);
        }
    ...
    public static async getEnergyAmountForSystemOperator(
        ...
        try {
            ...
            throw new Error(`ERROR createEnergyAmount getSystemOperator-> Input string NON-JSON value`);
        }
