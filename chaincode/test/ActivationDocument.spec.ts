...
//             const collectionNames:string[]=await ParametersController.getParameter(transactionContext, ParametersType.ACTIVATION_DOCUMENT);
...
//             const queryDate = Values.HTB_ActivationDocument_HTA_JustEndDate.endCreatedDateTime;
...
//             const registeredResourceMrid = Values.HTB_ActivationDocument_HTA_JustEndDate.registeredResourceMrid;
//             const query = `{
//             "selector": {
//                 "docType": "activationDocument",
...
//             await star.CreateActivationDocument(transactionContext, JSON.stringify(Values.HTB_ActivationDocument_HTA_JustEndDate));
...
//             const expectedEnd: ActivationDocument = JSON.parse(JSON.stringify(Values.HTB_ActivationDocument_HTA_JustEndDate));
...
//     //         const collectionNames:string[]=await ParametersController.getParameter(transactionContext, ParametersType.SITE);
//     //         transactionContext.stub.getPrivateData.withArgs(collectionNames[0], activationDocument_EndDate.registeredResourceMrid).resolves(Buffer.from(JSON.stringify(Values.HTA_site_valid)));
...
//     //         const collectionNames:string[]=await ParametersController.getParameter(transactionContext, ParametersType.SITE);
//     //         transactionContext.stub.getPrivateData.withArgs(collectionNames[0], Values.HTA_ActivationDocument_Valid.registeredResourceMrid).resolves(Buffer.from(JSON.stringify(Values.HTA_site_valid)));
//     //         transactionContext.stub.getState.withArgs(Values.HTA_yellowPage.originAutomationRegisteredResourceMrid).resolves(Buffer.from(JSON.stringify(Values.HTA_yellowPage)));
...
//     //         activationDocument.subOrderList = [ activationDocument_EndDate.activationDocumentMrid ];
//     //         activationDocument.reconciliation = false;
//     //         activationDocument.docType = "activationDocument";

//     //         activationDocument_EndDate.subOrderList = [ activationDocument.activationDocumentMrid ];
//     //         activationDocument_EndDate.reconciliation = false;
//     //         activationDocument_EndDate.docType = "activationDocument";
...
//     //         const collectionNames:string[]: string = await ParametersController.getParameter(transactionContext, ParametersType.ACTIVATION_DOCUMENT);
//     //         transactionContext.stub.getPrivateDataQueryResult.withArgs(collectionNames[0], queryBE).resolves(iteratorBE);
//     //         transactionContext.stub.getQueryResult.withArgs(queryBE).resolves(iteratorBE);
...
//     //         transactionContext.stub.putPrivateData.should.have.been.calledOnceWithExactly(collectionNames, siteInput.meteringPointMrid, Buffer.from(JSON.stringify(siteInput)));
//     //     });
//     // });
});
