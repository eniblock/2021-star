...
/*
        it('should return ERROR CreateEnergyAccount couple HTA missing to much optional fields', async () => {
            let star = new Star();
...
////////////////////////////////////    BEGIN     ////////////////////////////
////////////////////////////////////////////////////////////////////////////
    describe('Test CreateEnergyAccount Début HTB RTE', () => {
        it('should return ERROR on CreateEnergyAccount NON-JSON Value', async () => {
            let star = new Star();
            chaincodeStub.MspiID = 'RTEMSP';
            try {
...
////////////////////////////////////////////////////////////////////////////
    describe('Test GetEnergyAccountByProducer', () => {
        it('should return OK on GetEnergyAccountByProducer empty', async () => {
            let star = new Star();
            const producer = 'toto';
            let ret = await star.GetEnergyAccountByProducer(transactionContext, producer);
            ret = JSON.parse(ret);
        ...
        it('should return SUCCESS on GetEnergyAccountByProducer', async () => {
            ...
            let ret = await star.GetEnergyAccountByProducer(transactionContext, orderA.receiverMarketParticipantMrid);
            ret = JSON.parse(ret);
            console.log('ret=', ret)
        ...
        it('should return SUCCESS on getEnergyAccountByproducer for non JSON value', async () => {
            ...
            let retB = await star.GetEnergyAccountByProducer(transactionContext, orderB.receiverMarketParticipantMrid);
