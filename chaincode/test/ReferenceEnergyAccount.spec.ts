...
*/
    ...
    describe('Test CreateReferenceEnergyAccount HTB', () => {
        ...
        it('should return ERROR CreateReferenceEnergyAccount Site non-JSON value', async () => {
            ...
            transactionContext.stub.getPrivateData.withArgs(collectionName, Values.HTB_site_valid.meteringPointMrid).resolves(Buffer.from("XXX"));
        ...
        it('should return ERROR CreateReferenceEnergyAccount wrong sender', async () => {
            ...
            try {
                ...
                // console.info(err.message)
                expect(err.message).to.equal('Reference Energy Account, mismatch sender: rte does not have write access for '
        ...
        it('should return ERROR CreateReferenceEnergyAccount mismatch ', async () => {
            ...
            const collectionName=await ParametersController.getParameter(transactionContext, ParametersType.SITE);
            transactionContext.stub.getPrivateData.withArgs(collectionName, Values.siteHTBProdA.meteringPointMrid).resolves(Buffer.from(JSON.stringify(Values.siteHTBProdA)));
...
// ////////////////////////////////////////////////////////////////////////////
    describe('Test GetReferenceEnergyAccountForSystemOperator', () => {
        ...
        it('should return SUCCESS on GetReferenceEnergyAccountForSystemOperator', async () => {
            ...
            const expected: EnergyAccount[] = [ energy_account, Values.HTB_EnergyAccount_a4 ];
