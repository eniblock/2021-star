...
ENEDIS_ENERGYACCOUNTS=$(cat $DATA_PATH/02-EnergyAccount/61-v3-HTA-EnergyAccount.json | jq '.')
...
RTE_ENERGYACCOUNTS=$(cat $DATA_PATH/02-EnergyAccount/62-v3-HTB-EnergyAccount.json | jq '.')
